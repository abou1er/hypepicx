                            ...
                            //FILTER_VALIDATE_EMAIL vérifie que c'est bien une adresse mail qui a été rentré. que le type de l'input n'a pas été modifié dans la console
                                ...
                                if($mailexist == 0){ //si égal à zéro donc pas de doublon n'existe pas encore
                                        ...
                                        if($inputmdp1 === $inputmdp2){
                                            ...
                                            $insertmbr = $bdd->prepare ("INSERT INTO user(  pseudo, email, motdepasse, role_user, token_user) VALUES(?,?,?,'admin',?)");
                                            ...
                                            $insertmbr->execute(array($pseudo,$mail,$mdp,$token_user));
                                             $good  = "Le compte ADMIN a bien été créé! "."<a href='connexionAdmin.php'>Se connecter</a>";
...
<body>
  ...
  <div class="letitre"><h2>Ajouter un Admin</h2></div>
            ...
            <table>
               ...
               <tr>
                ...
                <!-- for="pseudo" lié à l'id pseudo, cliker sur pseudo me mettra dans linput lié -->
                 ...
                 <!-- value will be = a what will be entered in the input even if it is bad at reloading submit will always be written in the input $variableName is the secured variable of POST_$variableName -->
